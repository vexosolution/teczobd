                ...
                <div className='relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        <div className='inline-flex items-center gap-3 bg-green-300 text-green-600 pr-4 p-1 rounded-full text-xs sm:text-sm'>
                            <span className='bg-green-600 px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>NEWS</span> Free Shipping on Orders Above Tk 500! <ChevronRightIcon className='group-hover:ml-2 transition-all' size={16} />
                        </div>
                    ...
                    <Image className='sm:absolute bottom-0 right-0 md:right-0 w-full sm:max-w-sm' src={assets.hero_model_img} alt="" />
                </div>
